...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
        ...
        echo ' alert("Negative values cannot be transferred.. Entered Correct Values..!!")';  // showing an alert box.
        echo '</script>';
    }
...
?>
	...
	<div class="row intro py-1"  style="background-color :#75DCF5;" >
              <div class="col-sm-12 col-md">
               <br>
              <h2 class="text-center pt-4" style="color : black;">View Details of Customer</h2>
   </div>
		</div>
            <?php
                include 'config.php';
